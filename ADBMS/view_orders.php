                    ...
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td><button type='button' class='btn btn-warning change-color-btn' data-orderid='" . $row["orderID"] . "'>Pending</button></td>";
                                echo "</tr>";
                            }
                        } else {
        ...
        colorChangeBtns.forEach(function(btn) {
            btn.addEventListener('click', function() {
                ...
                if (btn.classList.contains('btn-info')) {
                    ...
                    updateStatus(orderId, 1); // Set status to confirmed
                } else {
                    btn.textContent = 'Pending';
                    updateStatus(orderId, 0); // Set status to pending
                }
            });
        });
